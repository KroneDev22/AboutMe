...
[__Bluesky__](https://bsky.app/profile/kronedev.bsky.social)
...
Hello, I'm Leona, a game programmer based on the Gold Coast.

I’ve had the idea of being a game programmer since I was in year seven (2010). In the last few years I have gotten comfortable working in Unity with C#, Unreal Engine 5 with Blueprints, and Godot. 
In trying to find the fun, I have worked on many projects spread over Unity, UE5, and Godot, with my current projects being in Godot. I make use of the KISS principle, because I find it makes things easier when working with a team. 
...
Away from the computer, I enjoy going to trivia nights, or just hanging out with friends. 
